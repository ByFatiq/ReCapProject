...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void CarGetByBrandId(CarManager carManager)
        {
            ...
            {
                Console.WriteLine("Brand {0} olan araba verisinin fiyati: {1} ve aciklama: {2}", car.BrandId, car.DailyPrice, car.CarDescription);
            }
        }
        ...
        private static void CarGetByColorId(CarManager carManager)
        {
            ...
            {
                Console.WriteLine("Color {0} olan araba verisinin fiyati: {1} ve aciklama: {2}", car.ColorId, car.DailyPrice, car.CarDescription);
            }
        }
...
*/
        ...
        private static void CarTest(CarManager carManager)
        {
            ...
            Car car6 = new Car() { CarId = 8, BrandId = 1, ColorId = 1, DailyPrice = 12314686, CarDescription = "*updated spor araba", ModelYear = 2020 };
